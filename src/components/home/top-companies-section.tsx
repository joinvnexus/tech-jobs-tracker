...
export function TopCompaniesSection({
  ...
  return (
    <section className="border-b bg-secondary/40 py-14">
      <div className="container-app space-y-8">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          {companies.map((company) => (
            <Card
              key={company.name}
              className="flex flex-col justify-between border-border/60 bg-card/90 p-4 shadow-sm transition hover:-translate-y-0.5 hover:border-brand-200 hover:shadow-md"
            >
